...
@extends('layouts.ganancias')
    ...
    <br>
        <table>  
            <tr>
                <td>Total de ganancias: <b class="text-success">$ {{ number_format($total) }}</b></td>
            </tr>
            <tr>
                <td>Total de gastos: <b class="text-danger">$ {{ number_format($total2) }}</b></td>
            </tr>
            @if ($total3 > 0)
                <tr>
                    <td>Total de ganancias: <b class="text-success">$ {{ number_format($total3) }}</b></td>
                </tr> 

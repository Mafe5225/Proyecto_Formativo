...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navar-background" style="background-color: #C7C9C8; navbar-dark bg-dark shadow">
<div>
    <img alt="Logo " src="{{ asset('imags/logoTienda.png') }}"  class="logo ms-4" id="Logo"> 
</div>

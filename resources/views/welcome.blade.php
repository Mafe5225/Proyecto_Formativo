...
<head>
    ...
    <body class=" h-100 text-center ">
        ...
        <div class="position-relative">
            ...
            <img src="{{ asset('image/tienda BV.png') }}" class="position-absolute top-0 start-50 translate-middle"  id="imagen" > 
        </div>
        <div id="vista">
            <div class="my-5 text-center" id="texto">
                <h3 class="text-center ">Saludos te damos la bienvenida a la tienda bella vista, Tu tienda amiga.</h3>
